...
sbatch --array=1-$njobs -p short -t 5:00:00 -e ./iotrash/s-%A_%a.out -o ./iotrash/s-%A_%a.out /home/cwolock/surv_vim_supplementary/sims/scenario4A/landmark/call_manage_sim.sh

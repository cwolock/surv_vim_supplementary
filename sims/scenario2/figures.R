...
# LANDMARK SIMS
landmark_dat <- readRDS("C:/Users/cwolo/Dropbox/UW/DISSERTATION/surv_vim_supplementary/scratch/scenario2_landmark.rds")
landmark_summ <- summarize_results(landmark_dat, scenario = "2", truth_list$truth, truth_list$var_truth)

# C-INDEX SIMS
cindex_dat <- readRDS("C:/Users/cwolo/Dropbox/UW/DISSERTATION/surv_vim_supplementary/scratch/scenario2_cindex.rds")
